...
qemu-system-x86_64 -m 512 -net nic,macaddr=52:54:00:f5:80:66  -net socket,listen=:6070  -net nic,vlan=2 -net user,vlan=2 -redir tcp:3333::22 -hda manager.img  -enable-kvm  &
qemu-system-x86_64 -m 512 -net nic,macaddr=52:54:00:12:34:56  -net socket,connect=127.0.0.1:6070 -net nic,vlan=2 -net user,vlan=2 -redir tcp:4444::22 -hda node.img  -enable-kvm &
